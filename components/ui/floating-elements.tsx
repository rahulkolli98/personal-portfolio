...
export const FloatingElements = ({
  ...
  return (
    <div
      className={cn(
        "flex w-full flex-col items-center justify-center space-y-16 overflow-hidden",
        className
      )}
    >
      {title && (
        <h2 className={cn("text-4xl font-bold text-zinc-100", titleClassName)}>{title}</h2>
      )}
      <div
        className={cn(
          "mx-auto grid w-full grid-cols-2 place-items-center gap-8 md:grid-cols-3 lg:grid-cols-4",
          gridClassName
        )}
      >
